	...
	*/
	...
	if($kd_rekening=='' and $pasar=='')
	{
		$list_sql = "SELECT a.nm_rekening,a.kd_rekening,a.bln_retribusi,a.thn_retribusi,a.ntpd,a.total_bayar,a.tgl_pembayaran,b.* FROM app_pembayaran_retribusi as a 
				LEFT JOIN (SELECT kd_billing,no_skrd,wp_wr_nama,wp_wr_alamat FROM app_skrd) as b ON (a.kd_billing=b.kd_billing)";
	}
	// laporan retribusi pasar muncul
	else if($kd_rekening=='4120120'){
	$list_sql = "SELECT a.nm_rekening,a.kd_rekening,a.bln_retribusi,a.thn_retribusi,a.ntpd,a.total_bayar,a.tgl_pembayaran,b.* FROM payment_retribusi_pasarx as a 
				LEFT JOIN (SELECT kd_billing,no_skrd,npwrd,wp_wr_nama,wp_wr_alamat,wp_wr_camat,kd_rekening FROM app_skrd_pasarx) as b ON (a.kd_billing=b.kd_billing) ";
	}
	...
	$list_sql = "SELECT a.nm_rekening,a.kd_rekening,a.bln_retribusi,a.thn_retribusi,a.ntpd,a.total_bayar,a.tgl_pembayaran,b.* FROM app_pembayaran_retribusi as a 
				LEFT JOIN (SELECT kd_billing,no_skrd,wp_wr_nama,wp_wr_alamat,wp_wr_camat,kd_rekening FROM app_skrd) as b ON (a.kd_billing=b.kd_billing) ";
