...
<script type="text/javascript">
	var fn = "<?=$fn;?>", rek = "<?=$kd_rekening;?>",pasar = "<?=$pasar;?>", tgl1 = "<?=$tgl_penerimaan_awal;?>", tgl2 = "<?=$tgl_penerimaan_akhir;?>", tip_l = "<?=$tipe_laporan;?>";
	...
	window.open('ajax/'+fn+'/'+filename+'?tgl1='+tgl1+'&tgl2='+tgl2+'&rek='+rek+'&pasar='+pasar, '_blank');	
