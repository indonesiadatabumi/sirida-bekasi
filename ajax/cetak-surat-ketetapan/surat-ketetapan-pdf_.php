  		...
  		<div style='padding:10px;'>
    			...
    			<tr>
    				...
    				<td align='center' style='border-right:1px solid #000;border-bottom:1px solid #000;' valign='top'>
    					...
    					<table border=0 style='100%' cellpadding=0 cellspacing=0>
    						<tr>
    							<td width='15%'>&nbsp;</td>
    							<td>Masa</td><td>&nbsp;&nbsp;: ".get_monthName($row1['bln_retribusi'])."</td></tr>
    						</tr>
    						<tr>
    							<td width='15%'>&nbsp;</td>
    							<td>Tahun</td><td>&nbsp;&nbsp;: ".$row1['thn_retribusi']."</td></tr>
    						</tr>
    					</table>
    				</td>
    		...
    		<table class='report' cellpadding=0 cellspacing=0>
    			...
    			<tbody>    				
    				<tr>
    					...
    					<td align='right' class='rborder'>".number_format($total_retribusi,0,',','.')."</td>
    				</tr>";
            ...
            if($total_denda>0){
              $html .= "<tr>
                ...
                <td align='right' style='border-top:none!important;' class='rborder'>".number_format($total_denda,0,',','.')."</td>
              </tr>";
            }
            ...
            <tr>
              ...
              <td align='right' class='rborder'>".number_format($total_bunga,0,',','.')."</td>
            </tr>
    				<tr>
    					<td colspan='2' style='border-top:none;'></td>  					
    					<td></td>
              <td style='border-left:none!important'>b.</td><td style='border-left:none!important'>Kenaikan</td>
              <td align='right' class='rborder'>".number_format($total_kenaikan,0,',','.')."</td>
    				</tr>
            
    				<tr>
    					<td colspan='2' style='border-top:none;border-bottom:none'></td>
    					<td colspan='3'>Jumlah Keseluruhan</td>
    					<td align='right' class='rborder'><b>".number_format($total_retribusi,0,',','.')."</td>
    				</tr>
    				<tr>
    				<td colspan='6' class='rborder'>
  	  				<table width='100%' style='margin:5px;'>
  	  				<tr>
  	  					<td width='5%' style='border:none;'>&nbsp;</td>
  	  					<td width='10%' style='border:none;'>Dengan Huruf</td>
  	  					<td style='border:1px solid #000;'><b>".ucwords(NumToWords($total_retribusi))." Rupiah ----</b></td>
  	  				</tr>
  	  				</table>
    				</td>  				  				
    				</tr>
    				...
    				<tr>
    				<td colspan='6' class='rborder bborder'>
    					<table border=0 width='100%'>
    					<tr>
