	...
	<table id='data-table-jq' class='table table-striped table-bordered table-hover' width='100%'>
		...
		<tbody>";
			...
			while($row = $list_of_data->FetchRow())
			{
				...
				<td align='center'>";					
	            	echo "
	            	<a href='ajax/".$fn."/print-preview.php?id=".$id_skrd."&mengetahui=".$mengetahui."' class='btn btn-xs btn-default' target='_blank'>
	                	<i class='fa fa-print'></i>
	                </a>
	                <a href='ajax/".$fn."/surat-ketetapan-pdf.php?id=".$id_skrd."&mengetahui=".$mengetahui."' class='btn btn-xs btn-default' target='_blank'>
