...
$sql = "SELECT 
          ...
          a.thn_retribusi, a.tgl_penetapan, a.kd_billing, a.no_perjanjian,
...
if ($n_skrd > 0) {
	...
	$tgl_penetapan = $row1['tgl_penetapan'];
...
<head>
	<meta charset="UTF-8">
	<title><?php echo $_SITE_TITLE; ?> - Surat Ketetapan Retribusi Daerah</title>
					...
					<td align="center" style="border-right:1px solid #000;border-bottom:1px solid #000;" valign="top">
						...
						<table border=0 style="100%" cellpadding=0 cellspacing=0>
							<tr>
								<td width="15%">&nbsp;</td>
								<td>Masa</td>
								<td>&nbsp;&nbsp;: <?php echo get_monthName($row1['bln_retribusi']); ?></td>
							</tr>
				</tr>
				<tr>
					<td width="15%">&nbsp;</td>
					<td>Tahun</td>
					<td>&nbsp;&nbsp;: <?php echo $row1['thn_retribusi']; ?></td>
				</tr>
				</tr>
			</table>
			</td>
			...
			<tr>
				<td colspan="3" style="border-bottom:1px solid #000;">
					<table width="100%">
						...
						<tr>
							<td>No. Perjanjian</td>
							<td>: <?php echo $row1['no_perjanjian']; ?></td>
						</tr>
						<tr>
							<td>Kode Billing</td>
			...
			<table class="report" cellpadding=0 cellspacing=0>
				<thead>
					<tr>
						<th width="4%">NO</th>
						<th>KODE REKENING</th>
						<th colspan="3" width="60%">JENIS RETRIBUSI</th>
						<th>JUMLAH</th>
					</tr>
				</thead>
				<tbody>
              ...
              <td align='right'>" . number_format($total_kenaikan, 0, ',', '.') . "</td>
    				...
    				<td colspan='6'>
    					...
    					<ol type='1' style='margin:0;padding:0;padding-left:15px;'>
    						<li>Harap penyetoran dilakukan melalui Kas Daerah pada Bank Jabar Banten.</li>
