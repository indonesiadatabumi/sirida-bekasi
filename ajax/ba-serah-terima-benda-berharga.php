	...
	<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
		<h1 class="page-title txt-color-blueDark">		
			...
			<i class="fa-fw fa fa-pencil-square-o"></i> 
				Pendataan
			<span>>  
				BA. Serah Terima Benda Berharga
			</span>
		</h1>
	</div>
						...
						<form class="form-horizontal" id="form-filter-permohonan-karcis" action="ajax/<?=$fn;?>/dataview.php" method="POST">							
							...
							<fieldset>								
								...
								<div class="form-group">
									<label class="control-label col-md-3">Periode Tgl. Berita Acara</label>
									<div class="col-md-2">
						                <input type="text" name="tgl_ba_awal" id="tgl_ba_awal" class="form-control datepicker" data-dateformat="dd-mm-yy" required/>
									</div>
									<div class="col-md-2">
						                <input type="text" name="tgl_ba_akhir" id="tgl_ba_akhir" class="form-control datepicker" data-dateformat="dd-mm-yy" required/>
									</div>
								</div>								
							</fieldset>
...
<script type="text/javascript">
	...
	var pagefunction = function() {
		...
		*/	
		...
		$("#tgl_ba_awal").mask('99-99-9999');
		$("#tgl_ba_akhir").mask('99-99-9999');		
	};
