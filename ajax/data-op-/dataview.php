	...
	<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">
		...
		<header>
			...
			<h2>
				<?php	
				if($addAccess)
					echo "<a href='ajax/".$fn."/form_content.php?act=add&npwrd=".$npwrd."&thn_retribusi=".$thn_retribusi."&kd_rekening=".$kd_rekening."&fn=".$fn."&men_id=".$men_id."' class='btn btn-default btn-xs' data-toggle='modal' data-target='#remoteModal'>";
				else
