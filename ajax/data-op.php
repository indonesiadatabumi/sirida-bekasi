							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-12">										
										...
										<button class="btn btn-primary" type="button" id="data-op-excel">
...
<script type="text/javascript">
			...
			loadScript("js/plugin/datatables/dataTables.tableTools.min.js", function(){
				loadScript("js/plugin/datatables/dataTables.bootstrap.min.js", function(){
					loadScript("js/plugin/datatable-responsive/datatables.responsive.min.js", function(){
						loadScript("js/plugin/masked-input/jquery.inputmask.bundle.min.js", function(){
	...
	$("#data-op-excel").on("click", function() {
		let npwrd = $("#npwrd").val();
		let tahun = $("#tahun_retribusi").val();
		let namawr = $("#nm_wp_wr").val();
		let nama_retribusi = $("#nm_retribusi").val();

		window.open("ajax/data-op/data-retribusi-excel.php?npwrd=" + npwrd + "&tahun=" + tahun + "&namawr=" + namawr + "&namret=" + nama_retribusi, '_blank');
	});
