	...
	<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
		<h1 class="page-title txt-color-blueDark">		
			...
			<i class="fa-fw fa fa-check-square-o"></i> 
				Penetapan
			<span>>  
				Cetak B.A Serah Terima Benda Berharga
			</span>
		</h1>
	</div>
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">
				...
				<header>
					...
					<h2>Pencarian BA. Serah Terima Benda Berharga</h2>
				</header>
						...
						<form class="form-horizontal" id="form-daftar-laporan" action="ajax/<?=$fn;?>/dataview.php" method="POST">
							...
							<fieldset>
								<div class="form-group">
									<label class="control-label col-md-2" for="no_berita_acara">No. Berita Acara <font color="red">*</font></label>
									<div class="col-md-5">
						                <div class="input-group input-group-md">						                    
						                    <div class="icon-addon addon-md">
						                        <input type="text" name="no_berita_acara" id="no_berita_acara" class="form-control" readonly required/>
						                        <input type="hidden" name="id_berita_acara" id="id_berita_acara"/>
						                        <label class="glyphicon glyphicon-search" rel="tooltip"></label>
						                    </div>						                    

						                    <span class="input-group-btn">
						                        <a href="ajax/<?=$fn;?>/event_news_list.php?fn=<?=$fn;?>" class="btn btn-default" data-toggle="modal" data-target="#browseModal">...</a>
						                    </span>
						                </div>
									</div>
								...
								<div class="form-group">
									<label class="control-label col-md-2" for="nm_pihak_kesatu">Pihak Kesatu</label>
									<div class="col-md-4">
						                <input type="text" name="nm_pihak_kesatu" id="nm_pihak_kesatu" class="form-control" readonly/>
									</div>
								</div>

								<div class="form-group">
									<label class="control-label col-md-2" for="nm_pihak_kedua">Pihak Kedua</label>
									<div class="col-md-4">
						                <input type="text" name="nm_pihak_kedua" id="nm_pihak_kedua" class="form-control" readonly/>
									</div>
								</div>

								<div class="form-group">
									<label class="control-label col-md-2" for="tgl_berita_acara">Tgl. Berita Acara</label>
									<div class="col-md-2">
						                <input type="text" name="tgl_berita_acara" id="tgl_berita_acara" class="form-control" readonly/>
									</div>
