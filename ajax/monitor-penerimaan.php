...
$sql = "SELECT a.id_pembayaran,a.kd_billing,b.no_skrd,b.nm_wp_wr,c.jenis_retribusi,to_char(a.tgl_pembayaran,'HH24:MI:SS') as waktu_pembayaran,a.total_retribusi,a.total_bayar, d.rrn
			...
			LEFT JOIN log_payment_qris as d ON (a.kd_billing=d.kode_billing)
...
<script type="text/javascript">
	var $tbody = $('#monitor-tbody'),
		$firstRow = $('#monitor-tbody tr:first-child'),
		$idle = $('#secondidle_fetching_livedata'),
		$totalRetribution = $('#total-retribution');
