						...
						<form class="form-horizontal" id="form-pencarian-retribusi-wr" action="ajax/<?=$fn;?>/dataview.php" method="POST">
							...
							<fieldset>
								<div class="form-group">
									<label class="control-label col-md-3" for="nm_rekening">Jenis Retribusi</label>
									<div class="col-md-5">
								...
								<div class="form-group">
									<label class="control-label col-md-3" for="nm_wr">Nama WR</label>
									<div class="col-md-4">
								...
								<div class="form-group">
									<label class="control-label col-md-3" for="nilai_per_lembar">Jum. Lembar/Blok, Nilai Per Lembar Rp.</label>
									<div class="col-md-1">
						                <input type="text" name="isi_per_blok" id="isi_per_blok" class="form-control" style="text-align:right" readonly/>
									</div>
									<div class="col-md-1">
						                <input type="text" name="nilai_per_lembar" id="nilai_per_lembar" class="form-control" style="text-align:right" readonly/>
									</div>
								</div>
			...
			loadScript("js/plugin/datatables/dataTables.tableTools.min.js", function(){
				loadScript("js/plugin/datatables/dataTables.bootstrap.min.js", function(){
					loadScript("js/plugin/datatable-responsive/datatables.responsive.min.js", function(){
						loadScript("js/plugin/masked-input/jquery.inputmask.bundle.min.js", pagefunction)
					});
				});
			});
		});
