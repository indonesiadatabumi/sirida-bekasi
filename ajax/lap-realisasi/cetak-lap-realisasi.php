...
if ($kd_rekening == '4120120') {
	...
	if ($kecamatan == '') {
		...
		$cond = "WHERE to_char(a.tgl_pembayaran,'yyyy-mm-dd') >= '" . $tgl1 . "' AND to_char(a.tgl_pembayaran,'yyyy-mm-dd') <='" . $tgl2 . "' and  b.kd_rekening='" . $kd_rekening . "' and b.wp_wr_camat='" . $kecamatan . "'";
	}
