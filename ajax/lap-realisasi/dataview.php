...
<script type="text/javascript">
	var fn = "<?=$fn;?>", tipe_retribusi = "<?=$tipe_retribusi ?>", rek = "<?=$kd_rekening;?>",kec = "<?=$kecamatan;?>", tgl1 = "<?=$tgl_penerimaan_awal;?>", tgl2 = "<?=$tgl_penerimaan_akhir;?>", tip_l = "<?=$tipe_laporan;?>";
	...
	window.open('ajax/'+fn+'/'+filename+'?tipe_retribusi='+tipe_retribusi+'&tgl1='+tgl1+'&tgl2='+tgl2+'&rek='+rek+'&kec='+kec, '_blank');
</script>
