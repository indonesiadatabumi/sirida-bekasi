						...
						<form class="form-horizontal" id="form-daftar-laporan" action="ajax/<?=$fn;?>/dataview.php" method="POST">
							...
							<fieldset>
								<div class="form-group">
									<label class="control-label col-md-2" for="tipe_retribusi">Tipe Retribusi</label>
									<div class="col-md-3">
										<select name="tipe_retribusi" id="tipe_retribusi" class="form-control">
											<option value="1" selected>SKRD</option>
