...
<head>
  <meta charset="UTF-8">
  <title><?php echo $_SITE_TITLE; ?> - Surat Tanda Setoran</title>
    ...
    <div style="padding:10px;">
      <table style="border:1px solid #000" cellpaddding=0 cellspacing=0 width="100%">
        <tr>
          ...
          <td align="center" style="border-bottom:1px solid #000;" valign="center" colspan="2">
            <h4 style="margin:0">Serie: <b>A</b></h4>

          </td>
        </tr>
        <tr>
          <td colspan="4" align="center"><h3><b>SURAT TANDA SETORAN</b></h3></td>
        </tr>
        <tr>
          <td colspan="4">
            <table width="100%">
              ...
              <tr>
                ...
                <td>KODE BAYAR</td>
                <td>:</td>
                <td><?= ($type == '2' ? $kobil : $row1['kd_billing']); ?></td>
              </tr>
              <tr>
                  ...
                  <table class="report" cellpadding="0" cellspacing="0">
                    ...
                    while ($row2 = $result->FetchRow()) {
                      ...
                      echo "<tr>
                          ...
                          <td align='right'>" . number_format(($type == '2') ? $total_retribusi : $row2['total_retribusi']) . "</td>
                          </tr>";
                    }
                    ...
                    echo "
                        <tr>
                          ...
                          <td align='right'>" . number_format(($type == '2') ? $total_retribusi : $grand_retribusi) . "</td>
                        </tr>
                    </tbody>";
                    ?>
                  </table>
              ...
              <tr>
                ...
                <td style="border:1px solid #000">
                  <b><?= ucwords(NumToWords(($type == '2') ? $total_retribusi : $grand_retribusi)); ?> Rupiah</b>
                </td>
              </tr>
              <tr>
                <td colspan="4" style="height:8px"></td>
        ...
        <tr style="height:160px;">
          ...
          <td style="border-top:1px solid #000;padding:5px" valign="top" width="33%">
            <br />
            <center>
              Uang tersebut di atas diterima pada:
              <br />
            <br />
              <br />
              <br />
