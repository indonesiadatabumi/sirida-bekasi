<?php
    ...
    $pdf->cell(8,3,'','LT',0,'L',1);

    $pdf->cell(68,6,'Surat Ketetapan Retribusi Daerah','LT',0,'C',1);
    $pdf->cell(60,6,'Wajib Retribusi','LT',0,'C',1);
    $pdf->cell(81,6,'SSRD','LT',0,'C',1);
    $pdf->cell(20,3,'','LT',0,'C',1);
    $pdf->cell(0,3,'','LRT',1,'C',1);

    $pdf->setY(28);
    $pdf->cell(7.7,6,'No.','L',0,'C',1);
    $pdf->setY(31);
    $pdf->setX(18);
    $pdf->cell(10,6,'No.','LT',0,'C',1);
    $pdf->cell(18,6,'Tgl.','LT',0,'C',1);
    $pdf->cell(20,6,'Jumlah','LT',0,'C',1);
    $pdf->cell(20,6,'Masa','LT',0,'C',1);

    $pdf->cell(30,6,'Nama','LT',0,'C',1);
    $pdf->cell(30,6,'Alamat','LT',0,'C',1);

    $pdf->cell(24,6,'No.','LT',0,'C',1);
    ...
    $pdf->cell(0,6,'SIMDA','LR',1,'C',1);

    $pdf->cell(7.7,3,'','L',0,'C',1);
    $pdf->setX(227);
    $pdf->cell(20,3,'','L',0,'C',1);
    $pdf->cell(0,3,'','LR',0,'C',1);
	...
	{
		$widths = array(8,10,18,20,20,30,30,24,18,20,19,20,22.5);
