...
$list_sql = "SELECT * FROM app_pengembalian_karcis WHERE fk_permohonan='" . $id_permohonan . "' ORDER BY tgl_pengembalian DESC ";
...
<div class="modal-body">
	...
	<section>
		<div class="row">
			<div class="col col-md-12">
				<legend>Log Pengembalian</legend>
			</div>
		</div>
	</section>
