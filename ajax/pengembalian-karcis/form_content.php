...
$arr_field = array(
	'no_awal_kembali', 'no_akhir_kembali', 'jumlah_blok_kembali', 'jumlah_lembar_kembali',
...
<script>
	...
	$("#no_akhir_kembali").on("keyup", function() {
		var no_awal = $("#no_awal_kembali").val();
		var no_akhir = $("#no_akhir_kembali").val();
		var no_awal1 = no_awal.replace(",", "");
		var no_akhir1 = no_akhir.replace(",", "");
		var jml_lembar = parseInt(no_akhir1) - parseInt(no_awal1);

		if (jml_lembar < 0) {
			$("#jumlah_lembar_kembali").val(0);
		} else {
			$("#jumlah_lembar_kembali").val(jml_lembar);
		}
	})
</script>