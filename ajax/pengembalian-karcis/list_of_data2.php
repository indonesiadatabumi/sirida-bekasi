...
echo "
	...
	<thead>
		<tr>
			...
			<th>Jumlah Blok</th>
			<th width='15%'>No. Awal - Akhir</th>
			<th>Jumlah Lembar</th>
			<th width='14%'>Total <br />Retribusi (Rp.)</th>
			<th>Status Bayar</th>
			<th>Kode Bayar</th>
			<th width='12%'>Aksi</th>
		</tr>
...
while ($row = $list_of_data->FetchRow()) {
	...
	echo "<tr>
				...
				<td align='right'>" . $row['kode_bayar'] . "</td>
				<td>";
		echo "<a class='btn btn-xs btn-default' title='Cetak kode bayar' target='_blank' href='ajax/pengembalian-karcis/kode_bayar_pdf.php?id=" . $id_permohonan . "&no_awal=".$row['no_awal_kembali']."&no_akhir=".$row['no_akhir_kembali']."'>
	...
	echo "
						...
						<input type='hidden' id='ajax-req-dt' name='kobay' value='" . $row['kode_bayar'] . "'/>
