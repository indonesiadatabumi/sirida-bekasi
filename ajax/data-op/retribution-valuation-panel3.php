				...
				<td valign='top' width='50%'>
					<table class='table table-striped' width='100%'>
						...
						<tbody>
							...
							<input type='hidden' class='decimal' name='".$prefix."bobot_resiko_kebakaran' id='".$prefix."bobot_resiko_kebakaran' style='width:100%;hidden-align:right;' value='0' onkeyup=\"mix_panel2_2_function3();\" required/>
							<input type='hidden' class='decimal' name='".$prefix."indeks_resiko_kebakaran' id='".$prefix."indeks_resiko_kebakaran' style='width:100%;hidden-align:right;' value='0' onkeyup=\"mix_panel2_2_function3();\" required/>
							<input type='hidden' name='".$prefix."nilai_resiko_kebakaran' id='".$prefix."nilai_resiko_kebakaran' style='width:100%;text-align:right;' value='0' class='autofill-bg' readonly/>
							<input type='hidden' class='decimal' name='".$prefix."bobot_zonasi_gempa' id='".$prefix."bobot_zonasi_gempa' style='width:100%;text-align:right;' value='0' onkeyup=\"mix_panel2_2_function3();\" required/>
							<input type='hidden' class='decimal' name='".$prefix."indeks_zonasi_gempa' id='".$prefix."indeks_zonasi_gempa' style='width:100%;text-align:right;' value='0' onkeyup=\"mix_panel2_2_function3();\" required/>
							<input type='hidden' name='".$prefix."nilai_zonasi_gempa' id='".$prefix."nilai_zonasi_gempa' style='width:100%;text-align:right;' value='0' class='autofill-bg' readonly/>
							<input type='hidden' class='decimal' name='".$prefix."bobot_ketinggian_bangunan' id='".$prefix."bobot_ketinggian_bangunan' style='width:100%;text-align:right;' value='0' onkeyup=\"mix_panel2_2_function3();\" required/>
							<input type='hidden' class='decimal' name='".$prefix."indeks_ketinggian_bangunan' id='".$prefix."indeks_ketinggian_bangunan' style='width:100%;text-align:right;' value='0' onkeyup=\"mix_panel2_2_function3();\" required/>
							<input type='hidden' name='".$prefix."nilai_ketinggian_bangunan' id='".$prefix."nilai_ketinggian_bangunan' style='width:100%;text-align:right;' value='0' class='autofill-bg' readonly/>
							<tr>
						...
						<table class='table table-striped' width='100%'>
							<thead>
								<tr>
									...
									<td rowspan='2' align='center'>Pembulatan Desimal<br /><sup><font color='red'>(6)</font></sup></td>
									<td rowspan='2' align='center'>Total Retribusi Bangunan (Rp.)<br /><sup><font color='red'>(1)*(2)*(3)*(4)*(5)*(6)</font></sup>
									</td>
								</tr>
								<tr>
							...
							<tbody>
								...
								<td><input type='text' class='decimal' name='".$prefix."pembulatan_desimal' id='".$prefix."pembulatan_desimal' style='width:100%;text-align:right;' value='".($act=='edit'?number_format($curr_data['pembulatan_desimal'],2,'.',','):'1.00')."' onkeyup=\"mix_panel2_2_function2()\" required/></td>
