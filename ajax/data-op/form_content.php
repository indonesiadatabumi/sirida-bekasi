...
<div class="modal-body no-padding">
	...
	<script>
		...
		function control_header_retribution(_this, order_num) {
			var $volume = $('#volume' + order_num),
				$tarif = $('#tarif' + order_num),
				$ketetapan = $('#ketetapan' + order_num),
				$kenaikan = $('#kenaikan' + order_num),
				$denda = $('#denda' + order_num),
				$bunga = $('#bunga' + order_num),
				$total = $('#total' + order_num);
		...
		function add_valuation_table_row1() {
			...
			var $body = $('#valuation1-body'),
				$lc_body = $('#valuation1-body > div.valuation1-row:last-child'),
				$n_valuation_row1 = $('#n_valuation_row1');
		...
		function add_valuation_table_row2_1() {
			var $tbody = $('#valuation2_1-tbody'),
				$lc_tbody = $('#valuation2_1-tbody tr:last-child'),
				$n_valuation_row = $('#imb12_n_valuation_row2_1');
		...
		function add_valuation_table_row2_2_1() {
			var $tbody = $('#valuation2_2_1-tbody'),
				$lc_tbody = $('#valuation2_2_1-tbody tr:last-child'),
				$n_valuation_row = $('#imb17_n_valuation_row2_2_1');
			var last_row_id = $lc_tbody.attr('id');
		...
		function add_valuation_table_row2_2_2() {
			var $tbody = $('#valuation2_2_2-tbody'),
				$lc_tbody = $('#valuation2_2_2-tbody tr:last-child'),
				$n_valuation_row = $('#imb17_n_valuation_row2_2_2');
			var last_row_id = $lc_tbody.attr('id');
		...
		function count_total_retribution(order_num) {
			var $ketetapan = $('#ketetapan' + order_num),
				$kenaikan = $('#kenaikan' + order_num),
				$denda = $('#denda' + order_num),
				$bunga = $('#bunga' + order_num),
				$total = $('#total' + order_num);
			var ketetapan = gnv($ketetapan.val()),
				kenaikan = gnv($kenaikan.val()),
				denda = gnv($denda.val()),
				bunga = gnv($bunga.val()),
				total = 0;
		...
		function count_grand_retribution_imb17() {
			var $total_retribusi_bangunan = $('#imb17_total_retribusi_bangunan'),
				$total_retribusi_prasarana = $('#imb17_total_retribusi_prasarana'),
				$total_penatausahaan = $('#imb17_total_penatausahaan'),
				$grand_total = $('#imb17_grand_total_retribusi');

			var total_retribusi_bangunan = gnv($total_retribusi_bangunan.val()),
				total_retribusi_prasarana = gnv($total_retribusi_prasarana.val()),
				total_penatausahaan = gnv($total_penatausahaan.val()),
				grand_total = 0;
		...
		function imb17_replacement(checked) {
			...
			var $total_retribusi_bangunan = $('#imb17_total_retribusi_bangunan'),
				...
				$total_penatausahaan = $('#imb17_total_penatausahaan'),
				$grand_total = $('#imb17_grand_total_retribusi');
			var total_retribusi_bangunan = 0,
				total_retribusi_prasarana = 0,
				total_penatausahaan = gnv($total_penatausahaan.val()),
				grand_total = 0;
			...
			if (checked) {
				...
				var $nilai_retribusi_bangunan = $('#imb17_tot_nilai_retribusi_bangunan'),
					$nilai_retribusi_prasarana = $('#imb17_grand_nilai_retribusi_prasarana');
		...
		function count_grand_retribution() {
			...
			var n_valuation_row1 = parseInt($('#n_valuation_row1').val()),
				grand_retribusi = 0;
		...
		function count_building_costs_imb12(order_num) {
			var $luas = $('#imb12_luas' + order_num),
				$nilai_satuan = $('#imb12_nilai_satuan' + order_num),
				$biaya_bangunan = $('#imb12_biaya_bangunan' + order_num);
			var luas = gnv($luas.val()),
				nilai_satuan = gnv($nilai_satuan.val()),
				biaya_bangunan = 0;
		...
		function count_building_value_imb12(order_num) {
			var $biaya_bangunan = $('#imb12_biaya_bangunan' + order_num),
				$kj = $('#imb12_kj' + order_num),
				$gb = $('#imb12_gb' + order_num),
				$lb = $('#imb12_lb' + order_num),
				$tb = $('#imb12_tb' + order_num),
				$nilai_bangunan = $('#imb12_nilai_bangunan' + order_num);
			var biaya_bangunan = gnv($biaya_bangunan.val()),
				kj = gnv($kj.val(), '1'),
				gb = gnv($gb.val(), '1'),
				lb = gnv($lb.val(), '1'),
				tb = gnv($tb.val(), '1'),
		...
		function count_total_area_imb17() {
			...
			var n_valuation_row2 = parseInt($('#imb17_n_valuation_row2_2_1').val()),
				total_luas = 0;
		...
		function count_integrity_index_value(type) {
			var $bobot = $('#imb17_bobot_' + type),
				$index = $('#imb17_indeks_' + type);
			$nilai = $('#imb17_nilai_' + type);

			var bobot = gnv($bobot.val()),
				index = gnv($index.val()),
				nilai = 0;
		...
		function count_infrastructure_retribution(order_num) {
			var $luas = $('#imb17_luas_prasarana' + order_num),
				$indeks_ps = $('#imb17_indeks_penggunaan_prasarana' + order_num),
				$harga_satuan = $('#imb17_harga_satuan_retribusi_prasarana' + order_num),
				$total_retribusi = $('#imb17_tot_nilai_retribusi_prasarana' + order_num);

			var luas = gnv($luas.val()),
				indeks_ps = gnv($indeks_ps.val()),
				harga_satuan = gnv($harga_satuan.val()),
				total_retribusi = 0;
		...
		function count_total_infrastructure_retribution() {
			var $grand_retribusi = $('#imb17_grand_nilai_retribusi_prasarana'),
				$total_retribusi_prasarana = $('#imb17_total_retribusi_prasarana');
			var n_valuation_row2 = parseInt($('#imb17_n_valuation_row2_2_2').val()),
				grand_retribusi = 0;
		...
		function count_total_building_retribution() {
			...
			var $total_lb = $('#imb17_total_luas_bangunan'),
				$indeks_prasarana = $('#imb17_indeks_prasarana'),
				$total_nilai_it = $('#imb17_total_nilai_indeks_terintegrasi'),
				$indeks_pg = $('#imb17_indeks_penggunaan_gedung'),
				$indeks_wp = $('#imb17_indeks_waktu_penggunaan'),
				$indeks_bbpt = $('#imb17_indeks_bangunan_bawah_permukaan_tanah'),
				$pemb_desimal = $('#imb17_pembulatan_desimal'),
				$harga_satuan = $('#imb17_harga_satuan_retribusi_bangunan'),
				$total_retribusi = $('#imb17_tot_nilai_retribusi_bangunan'),
				$total_retribusi_bangunan = $('#imb17_total_retribusi_bangunan');

			var total_lb = gnv($total_lb.val()),
				indeks_prasarana = gnv($indeks_prasarana.val()),
				total_nilai_it = gnv($total_nilai_it.val()),
				indeks_pg = gnv($indeks_pg.val()),
				indeks_wp = gnv($indeks_wp.val()),
				indeks_bbpt = gnv($indeks_bbpt.val()),
				pemb_desimal = gnv($pemb_desimal.val()),
				harga_satuan = gnv($harga_satuan.val()),
		...
		function count_total_building_value_imb12() {
			...
			var n_valuation_row2 = parseInt($('#imb12_n_valuation_row2_1').val()),
				total_bangunan = 0;
		...
		function count_imb_imb12(type) {
			var $total_perhitungan_nb = $('#imb12_total_perhitungan_nb'),
				$_koef = $('#imb12_koef_' + type);
			$nilai = $('#imb12_nilai_' + type);

			var total_perhitungan_nb = gnv($total_perhitungan_nb.val()),
				koef = gnv($_koef.val()),
				nilai = 0;
		...
		function count_total_imb12() {
			var $total_nilai_imb = $('#imb12_total_nilai_imb'),
				$imb_pengganti = $('#imb12_imb_pengganti'),
				$grand_total_imb = $('#imb12_grand_total_imb');
		...
		function set_tarif_dasar(order_num, tarif_dasar) {
			$("#tarif" + order_num).val(tarif_dasar)
		}
	</script>
