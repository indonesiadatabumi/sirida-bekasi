		...
		<tbody>";
			...
			while($row = $list_of_data->FetchRow())
			{
				...
				<td align='center'>";
	            	...
	            	echo "
	            	<a href='ajax/".$fn."/".$filename1."?id=".$id_nota."' class='btn btn-xs btn-default' target='_blank'>
	                	<i class='fa fa-print'></i>
	                </a>
	                <a href='ajax/".$fn."/".$filename2."?id=".$id_nota."' class='btn btn-xs btn-default' target='_blank'>
