          ...
          <table class="report2" cellpadding=0 cellspacing=0 style="font-size:0.9em">
            <thead>
              <tr>
                ...
                <th rowspan="2">INDEKS LOKALITAS</th>
                <th rowspan="2">SHST BANGUNAN GEDUNG SEDERHANA (Rp)</th>
                <th colspan="6">INDEKS TERINTEGRASI</th>
                <th rowspan="2">PEMBULATAN INDEKS INTEGRASI 3 DESIMAL</th>
                <th rowspan="2">INDEKS BANGUNAN GEDUNG TERBANGUN</th>
                <th rowspan="2">NILAI RETRIBUSI (Rp)</th>
              </tr>
              <tr>
                <th>INDEKS FUNGSI</th>
                <th>KLASIFIKASI</th>
                <th>BOBOT PARAMETER</th>
                <th>INDEKS PARAMETER</th>
                <th>BOBOT X INDEKS</th>
                <th>FAKTOR KEPEMILIKAN</th>
              </tr>
            </thead>
            <tbody>
              <?php
              ...
              echo "<tr>
              <td></td>
              <td><b>".strtoupper($row1['jenis_bangunan'])."</b></td>
              <td></td>
              <td></td>
              <td></td>
              <td></td>
              ...
              foreach (array_keys($arr_data2) as $index) {
                  $row = $arr_data2[$index];
                  ...
                  // Cek jika baris pertama atau kedua
                  if ($index == 0) {
                      echo "<td>Konstruksi Kolam</td>";
                  } elseif($index == 1){ 
                    echo "<td>Konstruksi Pembatas</td>";
                  }else {
                      echo "<td></td>";
                  }
              ...
              <tr>
              <td colspan='13' align='center' style='border-top:1px solid #000'><b>TOTAL NILAI RETRIBUSI</b></td>
