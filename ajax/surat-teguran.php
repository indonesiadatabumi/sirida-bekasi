                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-horizontal" id="form-pencarian-retribusi-wr" action="ajax/<?= $fn; ?>/dataview.php" method="POST">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group input-group-md">
                                            <input type="text" name="no_skrd1" id="no_skrd1" class="form-control" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="npwrd">No. Surat</label>
                                    <div class="col-md-6">
                                        <div class="input-group input-group-md">
                                            <input type="text" name="no_surat" id="no_surat" class="form-control" style="width: 400px;" required />
                                        </div>
                                    </div>
                                </div>
                                <!-- jenis retribusi -->
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="npwrd">Perihal Surat</label>
                                    <div class="col-md-2">
