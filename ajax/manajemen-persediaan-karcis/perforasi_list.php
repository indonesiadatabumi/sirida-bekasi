...
<div class="modal-body">	
	...
	<table class="table table-bordered table-striped table-hovered">
		<thead>
			...
			<th>Retribusi</th>
			<th>Nama WR</th>
			<th>Per Lembar/<br />Tot. Perforasi</th>
	...
	<script>		
		function choose(id_permohonan,nm_rekening,nm_wr,isi_per_blok,nilai_per_lembar)
		{
			$('#id_permohonan').val(id_permohonan);
			$('#nm_rekening').val(nm_rekening);
			$('#nm_wr').val(nm_wr);
			$('#nilai_per_lembar').val(nilai_per_lembar);
			$('#isi_per_blok').val(isi_per_blok);
			$('#browseModal').modal('hide');
			$('#form-pencarian-retribusi-wr').bootstrapValidator('revalidateField','nm_rekening');
		}
