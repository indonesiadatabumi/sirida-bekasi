...
<html>
      ...
      <div style="margin:10px;">
        ...
        echo "
        <table border=0>
        <tr><td>Status : ".$lbl_status.", Tipe : ".$lbl_tipe."</td></tr>        
        </table>
          ...
          <tbody>";
            if($list_of_data->RecordCount()>0)
            {
              ...
              while($row=$list_of_data->FetchRow())
              {
                ...
                if($src_tipe=='2'){
                  echo "<td align='right'>".number_format($nilai_total_perforasi)."</td>";
                }                
                echo "<td align='right'>".number_format($total_retribusi)."</td>";
                if($src_status!='1'){
              ...
              <tfoot>
                <tr>
                  ...
                  if($src_tipe=='2'){
                    echo "<td align='right'>".number_format($grand_nilai_perforasi)."</td>";
                  }
                  echo "<td align='right'>".number_format($grand_retribusi)."</td>";
                  if($src_status!='1'){
                    echo "<td></td>";
                  }
                echo "</tr>
            ...
            {
              echo "<tr><td colspan='9' align='center'>Data tidak tersedia !</td></tr>";
            }           
          echo "</tbody>
        </table>";
        ?>
